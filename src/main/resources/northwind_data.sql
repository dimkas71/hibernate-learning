/* Customers */
insert into northwind.customers (id, last_name, first_name, email, company, phone, address1, address2, city, state, postal_code, country) values 
...
/* Employees */
insert into northwind.employees (id, last_name, first_name, email, phone, address1, address2, city, state, postal_code, country, avatar, job_title, department, manager_id) values 
...
/* orders */
insert into northwind.orders (id, employee_id, customer_id, order_date, shipped_date, ship_name, ship_address1, ship_address2, ship_city, ship_state, ship_postal_code, ship_country, shipping_fee, payment_type, paid_date, order_status) values 
...
/* Products */
insert into northwind.products (id, product_code, product_name, description, standard_cost, list_price, target_level, reorder_level, minimum_reorder_quantity, quantity_per_unit, discontinued, category) values 
...
/* Order details */
insert into northwind.order_details (order_id, product_id, quantity, unit_price, discount, order_detail_status, date_allocated) values 
